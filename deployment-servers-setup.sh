#!/bin/bash
# Hardware requirements: AWS Linux 2 with minimum t2.micro type instance & port 8080(application port), 9100 (node-exporter port) should be allowed on the security groups
