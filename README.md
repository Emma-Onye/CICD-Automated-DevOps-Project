...
2) ###### Jenkins/Maven/Ansible
    ...
    - User data (Copy the following user data): https://github.com/Emma-Onye/CICD-Automated-DevOps-Project/blob/main/jenkins-maven-ansible-setup.sh
    - Launch Instance
...
3) ###### SonarQube
    ...
    - Key pair: Select or create a new keypair
    - User data (Copy the following user data): https://github.com/Emma-Onye/CICD-Automated-DevOps-Project/blob/main/sonarqube-setup.sh
    - Launch Instance
...
4) ###### Nexus
    ...
    - Key pair: Select or create a new keypair
    - User data (Copy the following user data): https://github.com/Emma-Onye/CICD-Automated-DevOps-Project/blob/main/nexus-setup.sh
    - Launch Instance
...
5) ###### EC2 (Dev/Stage/Prod)
    ...
    - Security Group (Open): 8080, 9100 and 22 to 0.0.0.0/0
    - Key pair: Select or create a new keypair
    - User data (Copy the following user data): https://github.com/Emma-Onye/CICD-Automated-DevOps-Project/blob/main/deployment-servers-setup.sh
    - Launch Instance
...
6) ###### Prometheus
    ...
    - User data (Copy the following user data): https://github.com/Emma-Onye/CICD-Automated-DevOps-Project/blob/main/prometheus-setup.sh
    - Launch Instance
...
7) ###### Grafana
    ...
    - Key pair: Select or create a new keypair
    - User data (Copy the following user data): https://github.com/Emma-Onye/CICD-Automated-DevOps-Project/blob/main/grafana-setup.sh
    - Launch Instance
